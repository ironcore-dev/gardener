...
var _ = Describe("HighAvailability", func() {
	DescribeTable("#GetReplicaCount",
		...
		Entry("component type 'server', failure-tolerance-type empty", ptr.To(""), "server", Equal(ptr.To(2))),
		Entry("component type 'server', failure-tolerance-type non-empty", ptr.To("foo"), "server", Equal(ptr.To(2))),
		Entry("component type 'controller', failure-tolerance-type nil", nil, "controller", Equal(ptr.To(2))),
		Entry("component type 'controller', failure-tolerance-type empty", ptr.To(""), "controller", Equal(ptr.To(1))),
		Entry("component type 'controller', failure-tolerance-type non-empty", ptr.To("foo"), "controller", Equal(ptr.To(2))),
	)
	...
	DescribeTable("#GetTopologySpreadConstraints",
		...
		Entry("1 zone, failure-tolerance-type empty", ptr.To(""), 2, 2, 1, labelSelector, false, ConsistOf(corev1.TopologySpreadConstraint{TopologyKey: "kubernetes.io/hostname", MaxSkew: 1, WhenUnsatisfiable: corev1.ScheduleAnyway, LabelSelector: &labelSelector})),
		Entry("1 zone, failure-tolerance-type non-empty", ptr.To("foo"), 2, 2, 1, labelSelector, false, ConsistOf(corev1.TopologySpreadConstraint{TopologyKey: "kubernetes.io/hostname", MaxSkew: 1, WhenUnsatisfiable: corev1.DoNotSchedule, LabelSelector: &labelSelector})),
		...
		Entry("2 zones, failure-tolerance-type empty", ptr.To(""), 2, 2, 2, labelSelector, false, ConsistOf(corev1.TopologySpreadConstraint{TopologyKey: "kubernetes.io/hostname", MaxSkew: 1, WhenUnsatisfiable: corev1.ScheduleAnyway, LabelSelector: &labelSelector})),
		Entry("2 zones, failure-tolerance-type non-empty", ptr.To("foo"), 2, 2, 2, labelSelector, false, ConsistOf(corev1.TopologySpreadConstraint{TopologyKey: "kubernetes.io/hostname", MaxSkew: 1, WhenUnsatisfiable: corev1.DoNotSchedule, LabelSelector: &labelSelector})),
		Entry("2 zones, failure-tolerance-type 'zone'", ptr.To("zone"), 2, 2, 2, labelSelector, false, ConsistOf(corev1.TopologySpreadConstraint{TopologyKey: "kubernetes.io/hostname", MaxSkew: 1, WhenUnsatisfiable: corev1.DoNotSchedule, LabelSelector: &labelSelector}, corev1.TopologySpreadConstraint{TopologyKey: "topology.kubernetes.io/zone", MaxSkew: 1, MinDomains: ptr.To(int32(2)), WhenUnsatisfiable: corev1.DoNotSchedule, LabelSelector: &labelSelector})),
