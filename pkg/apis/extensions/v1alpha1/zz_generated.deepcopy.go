...
func (in *CredentialsRotation) DeepCopyInto(out *CredentialsRotation) {
	*out = *in
	if in.CARotationLastInitiationTime != nil {
		in, out := &in.CARotationLastInitiationTime, &out.CARotationLastInitiationTime
		*out = new(string)
		**out = **in
	}
	if in.ServiceAccountKeyRotationLastInitiationTime != nil {
		in, out := &in.ServiceAccountKeyRotationLastInitiationTime, &out.ServiceAccountKeyRotationLastInitiationTime
		*out = new(string)
		**out = **in
	}
	return
...
func (in *InPlaceUpdateConfig) DeepCopyInto(out *InPlaceUpdateConfig) {
	*out = *in
	if in.UpdateScriptPath != nil {
		in, out := &in.UpdateScriptPath, &out.UpdateScriptPath
		*out = new(string)
		**out = **in
	}
	if in.UpdateScriptArgs != nil {
		in, out := &in.UpdateScriptArgs, &out.UpdateScriptArgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
