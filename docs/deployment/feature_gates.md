...
| InPlaceNodeUpdates        | `false` | `Alpha` | `1.109` |         |
...
| InPlaceNodeUpdates        | `gardener-apiserver`             | Enables setting the update strategy of worker pools to `InPlaceUpdate` or `InPlaceUpdateOnLabel` in Shoot API.                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
